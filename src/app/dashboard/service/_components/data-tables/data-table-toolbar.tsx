...
const DataTableToolbar: React.FC<DataTableToolbarProps> = ({
  fetchData, searchTerm, onSearchChange, searchPlaceholder, filters, setFilters,
  error, allColumnHeaders, visibleKeys, onViewOptionChange, onSortChange, sortColumn, sortOrder
}) => {
