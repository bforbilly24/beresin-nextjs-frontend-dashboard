...
export default function AppSidebar({ children }: { children: React.ReactNode }) {
	...
	return (
		<SidebarProvider>
			...
			<SidebarInset>
				<header className='flex h-20 shrink-0 items-center justify-between gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-20'>
